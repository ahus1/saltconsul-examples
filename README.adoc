...
There is a <<tutorial/tutorial{ext-relative},full tutorial>> in the `tutorial` sub folder on how to do this.

For experienced users there is a <<cheatsheet{ext-relative},minimal set of instructions>> in `cheatsheet.adoc`.
